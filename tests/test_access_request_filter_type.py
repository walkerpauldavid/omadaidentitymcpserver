...
async def test_access_request_filter_fields():
    ...
    filter_tests = [
        ...
        {
            "name": "beneficiary",
            "value": {"id": "a708e710-e1e6-45cc-a02d-8e0f0cc4127f"},
        },
...
async def test_single_filter_field(
    field_name, field_value, impersonate_user="robwol@54mv4c.onmicrosoft.com"
):
            ...
            if response.status_code == 200:
                ...
                if "data" in result and "accessRequests" in result["data"]:
                    ...
                    if access_requests:
                        ...
                        print(
                            f"  First result: {beneficiary.get('displayName', 'N/A')} (ID: {beneficiary.get('identityId', 'N/A')})"
                        )
                        print(
