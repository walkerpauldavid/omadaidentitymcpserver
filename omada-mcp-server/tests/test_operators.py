...
async def test_firstname_not_equals():
    ...
    display_filtered_result(
        result, "Test 1: Firstname NOT EQUALS 'Emma'", ["Id", "FIRSTNAME"]
    )
    ...
    display_filtered_result(
        result,
        "Test 2: Combined Operators (firstname ne 'Emma' AND lastname startswith 'T')",
...
async def test_other_operators():
    ...
    display_filtered_result(
        result,
        "Test 3: Contains Operator (firstname contains 'mm')",
        ["Id", "FIRSTNAME"],
    )
    ...
    display_filtered_result(
        result,
        "Test 4: Starts With Operator (lastname startswith 'Tay')",
        ["Id", "LASTNAME"],
    )
    ...
    display_filtered_result(
        result,
        "Test 5: Like Operator (firstname like 'Em%') - May not be supported",
        ["Id", "FIRSTNAME"],
    )
    ...
    display_filtered_result(
        result,
        "Test 6: Equals Operator (firstname eq 'Emma') - Reference working test",
        ["Id", "FIRSTNAME"],
    )
...
async def main():
    ...
    print(
        "This file contains updated tests but test_identity_search.py is now the recommended test file."
    )
